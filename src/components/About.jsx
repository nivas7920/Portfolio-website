        ...
        <div name="about" className='w-full h-auto bg-gradient-to-b from-gray-800 to-black text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-auto'>
                ...
                <p data-aos="slide-up" data-aos-duration="500" className='text-xl mt-5 ease-in fade-in'>
                    I embarked my journey as a B.E Computer Engineering student at JSPM's Bhivrabai Sawant Institute of Technology & Research, Wagholi, Pune 2025. Along the way, I fearlessly explored various fields, including Website Designing . I'm expertise in Data Structures and Algorithms (DSA), Development in ReactJs, NodeJs, MongoDB, MySQL & much more.  I'm committed to staying up to date with the latest trends and technologies in the field.
                    </p>
                <br />
                <p data-aos="slide-up" data-aos-duration="500" className='text-xl mt-5 ease-in fade-in'>
                In a constant pursuit of sharing knowledge and fostering growth.I have learning attitude and growth mindset which helps me to collaborate with people and work for the society.
                </p>
                {/* <br />
